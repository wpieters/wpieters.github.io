...
date: 2026-03-19
description: "The AI coding tools boom is giving me serious déjà vu — and not the good kind"
tags: ["tech", "ai", "vibe-coding", "tools", "gaming", "gamedev"]
categories: ["tech", "game-dev"]
canonicalURL: "https://wynandpieters.dev/posts/weve-seen-this-movie-before/"
cover:
    image: "posts/weve-seen-this-movie-before/images/banner.png"
    alt: "Cover image for We've Seen This Movie Before"
    caption: ""
---
...
[![Screenshot from SteamDB "Game Releases by Year" dashboard showing the clear upwards trajectory post 2014](images/steamdb-game-releases-per-year.png)](https://steamdb.info/stats/releases/)
...
[![Screenshot from Reddit around the Jim Sterling lawsuit](images/jimquisition.png)](https://www.reddit.com/r/Games/comments/5wg72n/when_jim_sterling_was_sued_for_10_million_by/)
...
![The classic "This is fine" meme of the dog drinking coffee while everything around him burns](images/this-is-fine.jpg)
...
![Photo of developer on Nintendo eShop with no single unique game, only obvious clones of popular indie games](images/eshop-clones.jpg)
...
![Gru's Plan meme going from "Ship a SaaS in 4 hours using AI" to "Users trust you with their real data" to "Database access keys hardcoded into front page"](images/gru-vibe-code-saas.jpg)
